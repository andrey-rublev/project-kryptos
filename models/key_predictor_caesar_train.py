...
# default paths
DEFAULT_DATA_PATH = r"C:\Users\nikhi\Downloads\Kryptos\data\output\caesar.csv"
...
class CaesarDataset(torch.utils.data.Dataset):
        ...
        with open(csv_path, "r", encoding="utf-8") as f:
            ...
            for row in reader:
                ...
                for _ in range(augment):
                    ...
                    new_cipher = caesar_cipher(plaintext, k)
                    self.samples.append((encode_text(new_cipher, max_len), k))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train Caesar key predictor")
    ...
    parser.add_argument("--augment", type=int, default=0,
                        help="number of extra re-encryptions per sample")
    parser.add_argument("--val-split", type=float, default=0.1)
    parser.add_argument("--patience", type=int, default=3,
                        help="early stopping patience on val_acc")
    args = parser.parse_args()

    full_dataset = CaesarDataset(args.data_path, args.max_len, augment=args.augment)
    ...
    model = CaesarKeyPredictor(VOCAB_SIZE,
